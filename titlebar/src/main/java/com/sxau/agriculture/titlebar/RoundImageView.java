...
public class RoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderThickness = a.getDimensionPixelSize(R.styleable.RoundImageView_borderThickness, 0);
        mBorderOutsideColor = a.getColor(R.styleable.RoundImageView_borderOutsideColor, defaultColor);
        mBorderInsideColor = a.getColor(R.styleable.RoundImageView_borderInsideColor, defaultColor);
    }
