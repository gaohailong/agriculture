 ...
 */
public class TitleBarTwo extends ViewGroup implements View.OnClickListener {
    ...
    public TitleBarTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TitleBarTwo(Context context, AttributeSet attrs, int defStyleAttr) {
