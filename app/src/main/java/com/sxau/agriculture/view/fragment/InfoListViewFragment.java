...
public class InfoListViewFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        infoDatas[0].setIvHead(R.mipmap.default_user_portrait);
        ...
        infoDatas[1].setIvHead(R.mipmap.default_user_portrait);
        ...
        infoDatas[2].setIvHead(R.mipmap.default_user_portrait);
        ...
        infoDatas[3].setIvHead(R.mipmap.default_user_portrait);
        ...
        infoDatas[4].setIvHead(R.mipmap.default_user_portrait);
